package pe.edu.upc.juantorres.security;
...
public class MyUserDetails implements UserDetails {//La clase UsuarioDetails es para acceder a tu entity user y sacar los datos
